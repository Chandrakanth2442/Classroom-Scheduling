...
def simulated_annealing(max_iter=1000, initial_temp=80, cooling_rate=0.99):
    ...
    print("SA Final Best Cost:", best_cost)
    return best_state

# Run Simulated Annealing
final_state_sa = simulated_annealing()
generate_html(final_state_sa, "schedule_sa.html")
